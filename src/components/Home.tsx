...
import KartikHeroScene from './KartikHeroScene';
...
const Home: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] items-center px-4 pb-24 pt-14 lg:py-20">
        <div className="grid w-full items-center gap-14 lg:grid-cols-[0.82fr_1.18fr] lg:gap-10 xl:grid-cols-[0.78fr_1.22fr]">
          <motion.div
          ...
          >
            ...
            <h1 className="text-5xl font-semibold tracking-[-0.045em] text-white sm:text-6xl lg:text-7xl xl:text-[4.8rem]">
              Backend systems
